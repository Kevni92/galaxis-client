...
4. Dieses Repository enthält ausschließlich den Desktop-Webclient von Galaxis.
5. Der Server ist fachlich autoritativ. Spielregeln dürfen im Client nicht unabhängig nachgebildet werden.
6. REST-Verträge unter `docs/contracts/rest-api/` sind verbindlich.
