...
| `router/index.ts`            | Routendefinition inkl. geschützter Kampagnen-/System-Deep-Links, `/login` und Auffangroute | Decision 0007, `docs/contracts/ui/raumansichten-auswahl-und-kontextaktionen.md`                             |
