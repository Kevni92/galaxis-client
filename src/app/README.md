...
| ---------------------------- | -------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------- |
| `shell/AppShell.vue`         | Minimale Shell mit Topbar-Platzhalter und Inhaltsbereich | [`docs/12-ui-ux/game-shell-und-fenstersystem.md`](../../docs/docs/12-ui-ux/game-shell-und-fenstersystem.md) |
| `error/AppErrorBoundary.vue` | Globale Fehlergrenze mit Ersatzdarstellung               | Decision 0007                                                                                               |
| `router/index.ts`            | Routendefinition inkl. Auffangroute                      | –                                                                                                           |
