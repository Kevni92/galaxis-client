...
| [`campaign/`](campaign/README.md)     | Kampagnenliste und Erstellung einer A1-Singleplayer-Kampagne        | [`docs/contracts/rest-api/galaxis-rest-v1-a1.yaml`](../../docs/contracts/rest-api/galaxis-rest-v1-a1.yaml) |
